      ...
      >
        <FuseScrollbars className="p-16 sm:p-32">
          ...
          <Typography className="mb-24 text-12 italic text-justify" color="text.secondary">
            * طرح رنگ انتخابی برای تمام عناصر طرح بندی تم (نوار نوار، نوار ابزار و غیره) اعمال خواهد شد. همچنین می‌توانید برای هر عنصر طرح‌بندی در تنظیمات تم، یک طرح رنگ متفاوت انتخاب کنید.
          </Typography>
