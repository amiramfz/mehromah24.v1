...
export default function TradeManagmentComponent() {
              ...
              body={(rowData) => (
                ...
                >
                  <div style={{ display: "flex", gap: 1 }}>
                    {rowData.Status !== 5 && rowData.Status !== 2 && (
                      <RouterLink
                        style={{ borderRadius: "50%" }}
                        to={
                          "/print/tickets/" +
                      ...
                      >
                        <IconButton>
                          <AirplaneTicketIcon style={{ color: "#334155" }} />
                        </IconButton>
                      </RouterLink>
                    )}
                    {/* FactorId */}
                    ...
                    {(rowData.Status == 5 || rowData.Status == 2) && (
                      <IconButton onClick={()=>{setErrorMessage(rowData.Description);handleClickOpenErrorDialog(); } }>
                        <DoNotTouchIcon style={{ color: "#334155" }} />
                      </IconButton>
                    )}
                  </div>
                </div>
